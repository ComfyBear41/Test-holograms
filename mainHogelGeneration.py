...
directory0 = '/home/fer/Desktop/Programs/3DHolograms/V8/Sub_images/'
dir_transfer = '/home/fer/Desktop/Programs/3DHolograms/V8/Transfer function'
...
N_TransFunction = len(os.listdir(directory0)) # Number of files in the directory
...
for p in range(N_TransFunction):
    ...
    directory1 = directory0 + os.listdir(directory0)[p] # Directory to access 
    ...
    HogelGeneration(H_plane,scale,H_size_i,H_size_j,N_proji,N_projj,N_cicles,crop_percentage,res,directory1,dir_transfer)
