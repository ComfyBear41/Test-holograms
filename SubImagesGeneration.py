...
# d_og = 10 # Distance from object to grid

# bpy.ops.mesh.primitive_grid_add(location =(-d_og*max_dim ,0,0), rotation = (0,radians(90),0), size=10*max_dim , scale = (100,100,100))
# perp_plane = bpy.context.active_object

# bpy.ops.mesh.primitive_grid_add(location =(0,0,-d_og*max_dim), rotation = (0,0,0), size=10*max_dim , scale = (100,100,100))
# paral_plane = bpy.context.active_object

# bpy.ops.mesh.primitive_grid_add(location =(0,-d_og*max_dim,0), rotation = (radians(90),0,0), size=10*max_dim , scale = (100,100,100))
# left_plane = bpy.context.active_object

# bpy.ops.mesh.primitive_grid_add(location =(0,d_og*max_dim,0), rotation = (radians(90),0,0), size=10*max_dim, scale = (100,100,100))
# right_plane = bpy.context.active_object

# # Create material
# new_material = bpy.data.materials.new(name = "Checker")

# # Creating the walls for the background
# perp_plane.data.materials.append(new_material)
# paral_plane.data.materials.append(new_material)
# left_plane.data.materials.append(new_material)
# right_plane.data.materials.append(new_material)

# # Activating the tree nodes for material manipulation
# new_material.use_nodes = True
# nodes = new_material.node_tree.nodes

# node_checker = nodes.new(type="ShaderNodeTexChecker") # Establishing Checker pattern
# node_checker.inputs[3].default_value = round(max_dim/2 + 14) # This line modifies the number of squares on the planes


# # Generating the links in the tree nodes
# bsdf = nodes.get("Principled BSDF")
# links = new_material.node_tree.links
# new_link = links.new(node_checker.outputs[0],bsdf.inputs[0])
